...
export async function planJulieInstruction(input: { instruction: string; activeClient?: { id: string; name: string } | null; history?: Array<{ role: string; content: string }>; workingMemory?:Record<string,unknown> }): Promise<JuliePlan | null> {
