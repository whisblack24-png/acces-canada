...
const tools: JulieToolName[] = ["create_client", "summarize_client", "list_incomplete_clients", "analyze_documents", "generate_document", "create_task", "create_reminder", "update_client", "add_note", "list_appointments", "list_pending_approvals", "request_signature", "recommend", "answer_from_records", "search_records", "delete_client", "rename_document", "move_document", "delete_document", "update_task", "move_appointment", "cancel_appointment", "generate_report"];
    ...
    properties: {
      ...
      actions: { type: "array", maxItems: 8, items: { type: "object", additionalProperties: false, properties: {
        tool: { type: "string", enum: tools }, clientQuery: { type: "string" }, arguments: { type: "object", additionalProperties: false, properties: {
          ...
          query: { type: "string" }, document_id: { type: "string" }, document_name: { type: "string" }, new_name: { type: "string" }, category: { type: "string" }, task_id: { type: "string" }, appointment_id: { type: "string" }, reason: { type: "string" }, report_type: { type: "string" },
        }, required: ["full_name", "email", "phone", "country", "service", "status", "notes", "desired_date", "title", "document_type", "question", "query", "document_id", "document_name", "new_name", "category", "task_id", "appointment_id", "reason", "report_type"] },
